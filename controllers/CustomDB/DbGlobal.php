...
class DbGlobal {
    ...
    $limit = 0, $offset = 0, $sort_by = [], $custom_where = ''){
        ...
        return $wpdb->get_results( static::prepareGetQuery( $table_name, $where, $select_column, $limit, $offset, $sort_by, $custom_where), ARRAY_A);
    }
...
class_alias('Bukvy\CustomDB\DbGlobal', 'DbGlobal' );
